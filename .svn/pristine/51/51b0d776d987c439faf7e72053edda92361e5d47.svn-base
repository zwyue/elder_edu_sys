                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        ...
                                        html += '<td><a onclick="sc_delect(' + item.id + ')" href="JavaScript:;" class="bg bgActive del">删除</a>' +
                                            '<a href="bzrgl_bzrgzsj_xg.html?id=' + item.id + '" class="bg change">修改</a>' +
                                            '<a href="bzrgl_bzrgzsj_ck.html?id=' + item.id + '" class="bg change">查看</a>' +
                                            '<a href="api/worknotes/export?id=' + item.id + '" class="bg look">导出</a></td>';
                                        html += '</tr>';
                                    })
                                    $("#list_bzrgzsj").html(html);
                                },
