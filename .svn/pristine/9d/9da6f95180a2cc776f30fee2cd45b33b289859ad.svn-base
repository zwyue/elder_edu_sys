...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <a class="btn btn-primary" href="/classes/add">新增</a>
        </div>
        <div>
            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach begin="0" step="1" items="${list}" var="list" varStatus="userlist">
                    <tr>
                        ...
                        <td>${list.crttime}</td>
                        <td>
                            <a type="button"  href="${path}/classes/query?id=${list.id}" class="btn btn-info btn-sm">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                编辑</a>
                            <a type="button"  href="${path}/classes/delete?id=${list.id}" class="btn btn-danger btn-sm">
