...
import com.zhu.base.dao.ClassSuggestDao;
...
public class ClassSuggestServiceImpl implements ClassSuggestService {
    ...
    public void exportClassIssueAndRecommendation(HttpServletResponse response, Integer... ids) {
        ...
        //excel标题
        String[] title = {SysConstant.SheetTitle.SERIAL_NUMBER, SysConstant.SheetTitle.QUESTION_OR_SUGGESTION, SysConstant.SheetTitle.QUESTION_OR_SUGGESTION_TIME, SysConstant.SheetTitle.SOLVE_AND_REPLY};
