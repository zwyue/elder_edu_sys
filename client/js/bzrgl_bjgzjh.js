                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        html += '<tr>';
                                        html += '<td>' + (i + 1) + '</td>';
                                        html += '<td>' + item.title + '</td>'+'<td>' + item.classname + '</td>'+'<td>' + item.recordtime + '</td>' ;
                                        html += '<td><a onclick="sc_delect(' + item.id + ')" href="JavaScript:;" class="bg bgActive del">删除</a>' +
                                            '<a href="bzrgl_bjgzjh_xg.html?id=' + item.id + '" class="bg change">修改</a>' +
                                            '<a href="bzrgl_bjgzjh_ck.html?id=' + item.id + '" class="bg change">查看</a>' +
                                            '<a href="api/workplan/export?id=' + item.id + '" class="bg look">导出</a></td>';
                                        html += '</tr>';
                                    })
                                    $("#list_bjgzjh").html(html);
                                },
                            ...
                            success: function (data) {
                                if (data.data.list.length == 0) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        chaXun += '<tr>';
                                        chaXun += '<td>' + (i + 1) + '</td>';
                                        chaXun += '<td>' + item.title + '</td>' + '<td>' + item.classname + '</td>' + '<td>' + item.recordtime + '</td>';
