                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        html += '<tr>';
                                        html += '<td>' + (i + 1) + '</td>';
                                        html += '<td>' + item.stuname + '</td>'+'<td>' + item.stunumber + '</td>'+'<td class="loadAge" id="color'+item.id+'">' + returnAge[i].age + '</td>'+
                            ...
                            success: function (data) {
                                if (data.data.list.length == 0) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        chaxun += '<tr>';
                                        chaxun += '<td>' + (i + 1) + '</td>';
                                        chaxun += '<td>' + item.stuname + '</td>' + '<td>' + item.stunumber + '</td>' + '<td id="color' + item.id + '">' + returnAge[i].age + '</td>' +
                                            '<td>' + item.termname + '</td>' + '<td>' + item.phone + '</td>' + '<td id="job(' + item.id + ')">' + item.isleader + '</td>';
