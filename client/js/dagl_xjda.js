                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data.data.list, function (i, result) {
                            html += "<tr>";
                            html += "<td>" + (i + 1) + "</td>" + "<td>" + result.stuname + "</td>" + "<td>" + result.classname + "</td>"
                            html += "<td>" + result.phone + "</td>" + "<td>" + result.famPhone + "</td>" + "<td>" + result.termname + "</td>";
                                ...
                                //"<td><a href='dagl_xyhdxg.html?id=" + result.id + "' class='bg change'>修改</a>" +
                                //"<a href='api/activities/export?id=" + result.id + "' class='bg look'>导出</a></td>";
                            html += "</tr>";
                        })
                        $("#listXjda").html(html);
                    },
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.data.list.length == 0) {
                                ...
                                $.each(data.data.list, function (i, result) {
                                    chaXun += "<tr>";
                                    chaXun += "<td>" + (i + 1) + "</td>" + "<td>" + result.stuname + "</td>" + "<td>" + result.classname + "</td>"
