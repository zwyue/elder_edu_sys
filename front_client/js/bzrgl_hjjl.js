                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        ...
                                        html += '<td>' + item.title + '</td>'+'<td>' + item.tname + '</td>'+'<td>' + item.recordtime + '</td>' ;
                                        html += '<td><a onclick="sc_delect(' + item.id + ')" href="JavaScript:;" class="bg bgActive del">删除</a>' +
                                            '<a href="bzrgl_hjjl_xg.html?id=' + item.id + '" class="bg change">修改</a>' +
                                            '<a href="bzrgl_hjjl_ck.html?id=' + item.id + '" class="bg change">查看</a>' +
                                            '<a href="api/awardrecord/export?id=' + item.id + '" class="bg look">导出</a></td>';
                                        html += '</tr>';
                                    })
                                    $("#list_hjjl").html(html);
                                },
                            ...
                            success: function (data) {
                                if (data.data.list.length == 0) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        ...
                                        chaXun += '<td>' + item.title + '</td>' + '<td>' + item.tname + '</td>' + '<td>' + item.recordtime + '</td>';
