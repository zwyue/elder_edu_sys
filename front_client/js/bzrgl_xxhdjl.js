                                ...
                                success: function (data) {
                                    ...
                                    $.each(data.data.list, function (i, item) {
                                        ...
                                        html += '<td><a onclick="sc_delect(' + item.id + ')" href="JavaScript:;" class="bg bgActive del">删除</a>' +
                                            '<a href="bzrgl_xxhdjl_xg.html?id=' + item.id + '" class="bg change">修改</a>' +
                                            '<a href="bzrgl_xxhdjl_ck.html?id=' + item.id + '" class="bg change">查看</a>' +
                                            '<a href="api/activityrecord/export?id=' + item.id + '" class="bg look">导出</a></td>';
                                        html += '</tr>';
                                    })
                                    $("#list_xxhdjl").html(html);
                                },
            ...
            function getTitle() {
                ...
                layui.use('laypage', function () {
                    ...
                    function getQuery() {
                        $.ajax({
                            type: 'GET',
                            url: "api/activityrecord/getTitle",
                            async: false,
                            data: {
                                title: title,
                                page: pageNum,
