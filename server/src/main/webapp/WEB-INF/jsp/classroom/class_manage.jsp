...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <a class="btn btn-primary" onclick="showForm('room_form',300,400)">新增</a>
...
<div id="room_form">
    ...
    <form action="/classroom/addNewClassRoom" method="post">
        <%--<div class="title">--%>
        <%--<h2>用户登录</h2><a onclick="layer.style.display=none"></a>--%>
        <%--</div>--%>
        <p><label>教室名称: </label><input type="input" name="classroom" /></p>
        <p><label>类别名称: </label><input type="input" name="cateid" /></p>
        <p><label>用    途: </label><input type="input" name="purpose" /></p>
        <p><label>地    址: </label><input type="input" name="address" /></p>
        <input type="submit" value=" 提 交 " />
    </form>
    <button onclick="closeForm('room_form')">关闭</button>
