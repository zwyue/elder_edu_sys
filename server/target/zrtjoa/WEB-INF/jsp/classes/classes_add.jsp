        ...
        <div class="col-md-12">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text"  name="classname" class="form-control" id="classname" placeholder="name">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text"  name="plansize" class="form-control" id="plansize" placeholder="phone">
                    </div>
                </div>
                <div class="form-group">
...
<script>
    function addUser(){
        ...
        $.ajax({
            type:"post",
            url:"/classes/save",
            data:{classname:classname,plansize:plansize,cateid:cateid,catename:catename,majorid:majorid,majorname:majorname},
            async:true,
