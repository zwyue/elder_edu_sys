...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-8">
            <a class="btn btn-primary" onclick="showForm('term_form',300,400)">新增</a>
            ...
            <table class="table table-hover table-striped">
                ...
                <c:forEach items="${list}" var="list">
                    <tr id="${list.id}">
                        ...
                        <td>${list.endtime}</td>
                        <td>${list.isEnableTxt}</td>
                        <td>
                            <a type="button" onclick="editTerm('term_form_update',300,400,'${list.term}','${list.starttime}','${list.endtime}','${list.id}')" class="btn btn-info btn-sm">
...
<div id="term_form">
    ...
    <form action="/term/createNewTerm" method="post">
        <%--<div class="title">--%>
    ...
    <button onclick="closeForm('term_form')">关闭</button>
